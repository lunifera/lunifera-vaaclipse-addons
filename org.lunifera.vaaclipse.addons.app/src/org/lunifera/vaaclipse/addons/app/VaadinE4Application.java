...
package org.lunifera.vaaclipse.addons.app;
...
import org.lunifera.vaaclipse.addons.app.webapp.VaadinWebApplication;
...
public class VaadinE4Application implements IApplication, ResourceInfoProvider {
	...
	private void startVaadinWebApplication() throws Exception {
		...
		if (appWidgetset == null || appWidgetset.trim().isEmpty()) {
			...
			// appWidgetset =
			// "platform:/plugin/org.semanticsoft.vaaclipse.resources/VAADIN/widgetsets/vaaclipse_widgetset.widgetset.Vaaclipse_widgetsetWidgetset";
		} else
