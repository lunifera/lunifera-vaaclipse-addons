 ...
 */
package org.lunifera.vaaclipse.addons.app.resources;
...
public class StaticResources extends HttpServlet {
	...
	@Reference(name = "bindHttpService", service = HttpService.class, target = "(org.lunifera.ecview.jetty.serviceType=application)", cardinality = ReferenceCardinality.MANDATORY)
	...
	public InputStream getInputStream(String url, Theme theme,
		...
		if (url.endsWith("favicon.ico")) {
			...
			if (segments[1].equals("widgetsets")) {
				// return
				// "platform:/plugin/org.semanticsoft.vaaclipse.resources" +
				// url;
